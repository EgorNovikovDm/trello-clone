<template>
    <div class="sm:bg-gray-100 h-full flex justify-center">
        <div class="container sm:mt-10 flex flex-col items-center">
            ...
            <div class="w-full sm:shadow-xl sm:bg-white sm:py-8 sm:px-12">
                ...
                <div class="text-center text-sm">
                    <router-link :to="{name: 'login'}" class="text-blue-600 hover:underline">Already have an account? Login in</router-link>
                </div>
            </div>
        </div>
    </div>
